...
const outputsInfo = {
    ...
    AggregateCommentSentiment: ["_count", "_min", "_max"],
    CommentSentimentGroupBy: ["id", "sentiment", "_count", "_min", "_max"],
    ...
    CommentSentimentCountAggregate: ["id", "sentiment", "_all"],
    CommentSentimentMinAggregate: ["id", "sentiment"],
    CommentSentimentMaxAggregate: ["id", "sentiment"],
...
const inputsInfo = {
    ...
    CommentSentimentWhereInput: ["AND", "OR", "NOT", "id", "sentiment"],
    CommentSentimentOrderByWithRelationInput: ["id", "sentiment"],
    CommentSentimentWhereUniqueInput: ["id", "AND", "OR", "NOT", "sentiment"],
    CommentSentimentOrderByWithAggregationInput: ["id", "sentiment", "_count", "_max", "_min"],
    CommentSentimentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "sentiment"],
    ...
    CommentSentimentCreateInput: ["id", "sentiment"],
    CommentSentimentUpdateInput: ["id", "sentiment"],
    CommentSentimentCreateManyInput: ["id", "sentiment"],
    CommentSentimentUpdateManyMutationInput: ["id", "sentiment"],
    ...
    CommentSentimentCountOrderByAggregateInput: ["id", "sentiment"],
    CommentSentimentMaxOrderByAggregateInput: ["id", "sentiment"],
    CommentSentimentMinOrderByAggregateInput: ["id", "sentiment"],
